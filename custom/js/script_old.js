...
function setuserProfile() {
    if (localStorage.getItem("userInfo") != "" && localStorage.getItem("userInfo") != null) {
        ...
        var profilePicPopOverContent='<div id="popupProfile"><div class="profilePopUP"><img id="popoverProfileImg" src="data:image/png;base64,'+ userDetails[0].pic+'"><span class="profileName left">'+userDetails[0].FirstName+ ' ' +userDetails[0].LastName +'</span><span class="profilePhoneNo left">'+userDetails[0].Phone+ '</span><span class="profileLink left"><a href="profile.html">My Profile</a></span><span class="profileOrder left"><a href="my-orders.html" data-toggle="modal" data-target="#myOrderModel">My Orders</a></span></div></div>'
